...
cout << texData.glTypeInternal << " = " << GL_BGRA << " " << texData.pixelType << " = " << GL_UNSIGNED_INT_8_8_8_8_REV << endl;
...
//cout << texData.glType << " = " << GL_BGRA << " " << texData.pixelType << " = " << GL_UNSIGNED_INT_8_8_8_8_REV << endl;
